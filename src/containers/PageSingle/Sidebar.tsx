...
export const Sidebar: FC<SidebarProps> = ({ className = "space-y-6 ",postid }) => {
  return (
    <div className={`nc-SingleSidebar ${className}`}>
      <WidgetPosts postid={postid} posts={widgetPosts} />
      <WidgetTags postid={postid} tags={tags} />
      <WidgetCategories postid={postid} categories={categories} />
