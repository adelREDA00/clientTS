    ...
    >
      ...
      <div className="p-4 sm:p-5 flex flex-col">
        <div className="space-y-3">
          <CategoryBadgeList itemClass="relative" postdataCategory={categories} />
          <h2
        ...
        <CardAuthor2 className="relative my-4" date={createdAt.substring(0, 10)} username={user.username} />
